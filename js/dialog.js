...
function addpicshow(filename, getbyid, iswidth) {
...
function windowsdig(title, content, width, height, cssName, isclose, iftype) {
    ...
    case "iframe":
        ...
        $("#dialogcontentlist").html("<iframe name=\"diglogfirameclass\" id=\"diglogfirameclass\" src=\"" + content + "\" height=\"" + (parseInt(height) - 30) + "px" + "\" frameborder=\"0\" marginheight=\"0\" marginwidth=\"0\"></iframe>")
    }
    $("#floatBoxBg").show();
    $("#floatBoxBg").animate({
        opacity: "0.4"
