...
<title><?php echo lang('添加站点');?> - <?php echo core_config::get('admin_title');?> - Power By Sutoo CMS</title>
...
<ul id="tab">
<li id="tab1" class="hover"><?php echo lang('添加站点');?></li>
</ul>
...
<table width="100%" class="table_form" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td><input type="text" class="input-text" name="sitename" id="sitename" size="30"/></td>
  </tr>     
  <tr>
    <th><?php echo lang('站点域名');?></th>
    <td><input type="text" class="input-text" name="sitedomain" id="sitedomain" size="30"/>
